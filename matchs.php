...
<p>
 <?php echo $donnees['HomeTeam']." "."vs"." ".$donnees['AwayTeam'].'<form method="POST">
    <input type="radio" name="mon_champ" value="Option 1"/> 1 
    <input type="radio" name="mon_champ" value="Option 2"/>N  
    <input type="radio" name="mon_champ" value="Option 2"/> 2 
    <input type="submit" value="Parier"/>
</form>'; ?></p>
<?php
print $_POST['mon_champ'];
?>
<?php
}
